...
static NSString *const LGFTabBarDoubleSelectNotification = @"LGFTabBarDoubleSelectNotification";
...
@property (nonatomic, assign) BOOL lgf_ShowTopShadow;
...
@property (weak, nonatomic) IBOutlet UIVisualEffectView *lgf_TabBarView;
